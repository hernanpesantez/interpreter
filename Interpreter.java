...
public abstract class Interpreter extends Parser {
    ...
    /*
     * argv[0]: source program file containing function definitions argv[1]:
     * lexical/syntactical error messages for the source program in argv[0] argv[2]:
     * single expression to be evaluated argv[3]: lexical/syntactical error messages
     * for the expression in argv[2]
     * 
